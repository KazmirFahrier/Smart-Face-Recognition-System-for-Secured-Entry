...
#cascade = "C:\Users\ASUS\Pictures\Samsung Flow\haarcascade_frontalface_default.xml"
...
collection = ["Sakif", "Raju", "Rafid", "Kajmir", "Anjan"]
v = len(collection)
p = [0] * v

def detecting(name):
    global p
    position = collection.index(name)
...
while True:
	...
	for encoding in encodings:
		...
		# encodings
		matches = face_recognition.compare_faces(data["encodings"],encoding,tolerance=0.47)
		name = "Unknown"
